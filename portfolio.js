...
// Observe website cards and service cards
document.querySelectorAll('.website-card, .servico-card').forEach(card => {
...
contactForm.addEventListener('submit', function(e) {
    ...
    const whatsappMessage = `Olá! Meu nome é ${name}.%0A%0AEmail: ${email}%0AAssunto: ${subject}%0A%0AMensagem: ${message}`;
...
// Add hover effect for website cards
...
const revealElements = document.querySelectorAll('.website-card, .servico-card');
